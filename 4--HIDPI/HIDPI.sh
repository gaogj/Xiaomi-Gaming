...
function choose_icon()
{
    ...
    echo ""
    echo "-------------------------------------"
    echo "|********** ${langChooseIcon} (小米游戏本建议选择 (3) ) ***********|"
    echo "-------------------------------------"
    echo ""
    echo "(1) iMac"
    echo "(2) MacBook"
...
case ${res} in
    1 ) create_res_1 1920x1080 1600x900 1440x810 1280x720 1024x576
    ;;
    2 ) create_res_1 1600x900 1424x802 1280x720 1024x576
    ;;
    3 ) create_res_1 2048x1152 1920x1080 1600x900 1440x810 1280x720
...
create_res_4 1600x900 1440x810 1280x720 1024x576 960x540 840x472 800x450 640x360
